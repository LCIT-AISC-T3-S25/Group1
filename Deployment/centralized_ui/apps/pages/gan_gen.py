...
# Label options
label_map = {"Food": 0, "Drink": 1, "Inside": 2, "Outside": 3}
...
if st.button("Generate Image"):
    try:
        ...
        response = requests.get(
            "http://localhost:8002/generate", params={"label": label_id}
        )
        ...
        if response.status_code == 200:
            ...
            st.markdown(
                f"<h4 style='text-align: center;'>Generated for: {selected_label}</h4>",
